...
// Table view for display search result.
...
class SearchResultTableViewController: UITableViewController, UISearchResultsUpdating {
    ...
    weak var handleMapSearchDelegate: LocationViewController?
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...let selectedItem = matchingItems[indexPath.row].placemark
